    ...
    <div className='px-2 pt-2'>
      <div className='grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4'>
        {Array.from({ length: skeletonCount }).map((_, index) => (
          <Card
            key={index}
            className='pricing-market-skeleton-card !rounded-2xl'
          ...
          >
            ...
            <div className='mb-4'>
              <Skeleton.Paragraph rows={2} style={{ marginBottom: 0 }} title={false} />
            </div>
            ...
            {showRatio && (
              <div className='pricing-market-skeleton-ratio mt-4 pt-3'>
