...
const FooterBar = () => {
  ...
  const logo = getLogo();
  const baseUrl = withBrowserBaseUrl();
  ...
  const customFooter = useMemo(
    () => (
      <footer
        className='relative h-auto md:px-24 w-full flex flex-col items-center justify-between overflow-hidden'
        style={{
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 w-full'>
              <div className='text-left'>
                ...
                <div className='flex flex-col gap-4'>
                  <a
                    href={withBrowserBaseUrl('/wiki/project-introduction/')}
                    target='_blank'
                  ...
                  <a
                    href={withBrowserBaseUrl('/support/community-interaction/')}
                    target='_blank'
                    rel='noopener noreferrer'
                    className='!text-semi-color-text-1'
                  >
                  ...
                  <a
                    href={withBrowserBaseUrl('/wiki/features-introduction/')}
                    target='_blank'
                    rel='noopener noreferrer'
                    className='!text-semi-color-text-1'
                  >
              ...
              <div className='text-left'>
                ...
                <div className='flex flex-col gap-4'>
                  <a
                    href={withBrowserBaseUrl('/wiki/getting-started/')}
                    target='_blank'
                    rel='noopener noreferrer'
                    className='!text-semi-color-text-1'
                  >
                  ...
                  <a
                    href={withBrowserBaseUrl('/wiki/installation/')}
                    target='_blank'
                    rel='noopener noreferrer'
                    className='!text-semi-color-text-1'
                  >
                  ...
                  <a
                    href={withBrowserBaseUrl('/wiki/api/')}
                    target='_blank'
                    rel='noopener noreferrer'
                    className='!text-semi-color-text-1'
                  >
    ...
    [logo, systemName, t, currentYear, isDemoSiteMode, baseUrl],
  );
