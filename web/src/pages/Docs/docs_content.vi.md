...
Truy cập [https://allrouter.ai/](https://allrouter.ai/), bấm **Đăng nhập** -> **Đăng ký**, nhập tên người dùng và mật khẩu trong cửa sổ bật lên, sau đó bấm **Đăng ký** để tạo tài khoản.
...
Truy cập [https://allrouter.ai/](https://allrouter.ai/), bấm **Đăng nhập**, nhập tên người dùng và mật khẩu, sau đó bấm **Tiếp tục** để đăng nhập vào AllRouter.AI.
