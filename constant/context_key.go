...
const (
	...
	ContextKeyModelContentAuditResponseText  ContextKey = "model_content_audit_response_text"
	ContextKeyModelContentAuditReasoningText ContextKey = "model_content_audit_reasoning_text"
