...
func InitOptionMap() {
	...
	common.OptionMap["InviteConsumeRebateRatioLevel2"] = strconv.FormatFloat(common.InviteConsumeRebateRatioLevel2, 'f', -1, 64)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "LakalaPublicCert":
		setting.LakalaPublicCert = value
	case "LakalaMerchantNo":
	...
	case "InviteConsumeRebateRatioLevel2":
		common.InviteConsumeRebateRatioLevel2, _ = strconv.ParseFloat(value, 64)
